...
import com.stratahealth.pages.HomePage;
import com.stratahealth.util.OptionsManager;
...
public class BasePage {
    ...
    public Properties init_prop() {
        ...
        try {
            fis = new FileInputStream("./src/main/java/com.stratahealth/config/config.properties");
            prop.load(fis);
        } catch (IOException e) {
            e.printStackTrace();
        }
